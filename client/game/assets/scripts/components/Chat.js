cc.Class({
    ...
    onLoad: function () {
        ...
        this._btnChat.active = cc.jzc.replayMgr.isReplay() == false;
    ...
    onQuickChatItemClicked:function(event){
        ...
        cc.jzc.net.send("quick_chat",info.index); 
    },
    
    onEmojiItemClicked:function(event){
        console.log(event.target.name);
        this._chatRoot.active = false;
        cc.jzc.net.send("emoji",event.target.name);
    },
    ...
    onBtnSendChatClicked:function(){
        ...
        cc.jzc.net.send("chat",this._iptChat.string);
