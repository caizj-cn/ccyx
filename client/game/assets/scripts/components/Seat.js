cc.Class({
    ...
    onLoad: function () {
        ...
        if(this._sprIcon && this._sprIcon.getComponent(cc.Button)){
            cc.jzc.utils.addClickEvent(this._sprIcon,this.node,"Seat","onIconClicked");    
        }
    ...
    onIconClicked:function(){
        ...
        if(this._userId != null && this._userId > 0){
           var seat = cc.jzc.gameNetMgr.getSeatByID(this._userId);
            var sex = 0;
            if(cc.jzc.baseInfoMap){
                var info = cc.jzc.baseInfoMap[this._userId];
                if(info){
                    sex = info.sex;
                }                
            }
            cc.jzc.userinfoShow.show(seat.name,seat.userid,iconSprite,sex,seat.ip);         
        }
    },
    ...
    refresh:function(){
        ...
        if(this._ready){
            this._ready.active = this._isReady && (cc.jzc.gameNetMgr.numOfGames > 0); 
        }
    ...
    refreshXuanPaiState:function(){
        ...
        this._xuanpai.active = cc.jzc.gameNetMgr.isHuanSanZhang;
        if(cc.jzc.gameNetMgr.isHuanSanZhang == false){ 
            return;
        }
