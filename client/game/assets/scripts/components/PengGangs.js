cc.Class({
    ...
    onPengGangChanged:function(seatData){
        ...
        var localIndex = cc.jzc.gameNetMgr.getLocalIndex(seatData.seatindex);
    ...
    initPengAndGangs:function(pengangroot,side,pre,index,mjid,flag){
        ...
        if(pengangroot.childrenCount <= index){
            if(side == "left" || side == "right"){
                pgroot = cc.instantiate(cc.jzc.mahjongmgr.pengPrefabLeft);
            }
            else{
        ...
        for(var s = 0; s < sprites.length; ++s){
            ...
            if(sprite.node.name == "gang"){
                ...
                if(flag == "angang"){
                    sprite.spriteFrame = cc.jzc.mahjongmgr.getEmptySpriteFrame(side);
