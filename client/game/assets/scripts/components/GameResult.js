cc.Class({
    ...
    onLoad: function () {
        ...
        if(btnClose){
            cc.jzc.utils.addClickEvent(btnClose,this.node,"GameResult","onBtnCloseClicked");
        }
        
        var btnShare = cc.find("Canvas/game_result/btnShare");
        if(btnShare){
            cc.jzc.utils.addClickEvent(btnShare,this.node,"GameResult","onBtnShareClicked");
        }
