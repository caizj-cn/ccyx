cc.Class({
    ...
    onBtnHistoryClicked:function(){
        ...
        var self = this;
        cc.jzc.userMgr.getHistoryList(function(data){
    ...
    getGameListOfRoom:function(idx){
        ...
        cc.jzc.userMgr.getGamesOfRoom(roomInfo.uuid,function(data){
    ...
    getDetailOfGame:function(idx){
        ...
        cc.jzc.userMgr.getDetailOfGame(roomUUID,idx,function(data){
            data.base_info = JSON.parse(data.base_info);
            data.action_records = JSON.parse(data.action_records);
            cc.jzc.gameNetMgr.prepareReplay(self._curRoomInfo,data);
            cc.jzc.replayMgr.init(data);
