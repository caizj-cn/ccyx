...
cc.Class({
    ...
    prepare:function(filename){
        ...
        cc.jzc.audioMgr.pauseAll();
        this.clearCache(filename);
        if(cc.sys.os == cc.sys.OS_ANDROID){
            jsb.reflection.callStaticMethod("com/jzc/voicesdk/VoiceRecorder", "prepare", "(Ljava/lang/String;)V",filename);
        }
    ...
    release:function(){
        ...
        if(cc.sys.os == cc.sys.OS_ANDROID){
            jsb.reflection.callStaticMethod("com/jzc/voicesdk/VoiceRecorder", "release", "()V");
        }
        else if(cc.sys.os == cc.sys.OS_IOS){
    ...
    cancel:function(){
        ...
        cc.jzc.audioMgr.resumeAll();
        if(cc.sys.os == cc.sys.OS_ANDROID){
            jsb.reflection.callStaticMethod("com/jzc/voicesdk/VoiceRecorder", "cancel", "()V");
        }
        else if(cc.sys.os == cc.sys.OS_IOS){
    ...
    play:function(filename){
        ...
        cc.jzc.audioMgr.pauseAll();
        if(cc.sys.os == cc.sys.OS_ANDROID){
            jsb.reflection.callStaticMethod("com/jzc/voicesdk/VoicePlayer", "play", "(Ljava/lang/String;)V",filename); 
        }
        else if(cc.sys.os == cc.sys.OS_IOS){
    ...
    stop:function(){
        ...
        cc.jzc.audioMgr.resumeAll();
        if(cc.sys.os == cc.sys.OS_ANDROID){
            jsb.reflection.callStaticMethod("com/jzc/voicesdk/VoicePlayer", "stop", "()V"); 
        }
        else if(cc.sys.os == cc.sys.OS_IOS){
    ...
    getVoiceLevel:function(maxLevel){
        ...
        if(cc.sys.os == cc.sys.OS_ANDROID){ 
            return jsb.reflection.callStaticMethod("com/jzc/voicesdk/VoiceRecorder", "getVoiceLevel", "(I)I",maxLevel);
        }
        else if(cc.sys.os == cc.sys.OS_IOS){
        }
        else{
    ...
    setStorageDir:function(dir){
        ...
        if(cc.sys.os == cc.sys.OS_ANDROID){ 
            jsb.reflection.callStaticMethod("com/jzc/voicesdk/VoiceRecorder", "setStorageDir", "(Ljava/lang/String;)V",dir);    
        }
        else if(cc.sys.os == cc.sys.OS_IOS){
